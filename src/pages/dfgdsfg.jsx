  ...
  return (
    <div className={`${bgClass} px-4 py-8 container`}>
      <Link
        ...
        } max-w-xl w-full mx-auto mb-8 text-black hover:underline font-spartan font-bold block text-start`}
      >
        🔙 Go Back
      </Link>
      ...
      <div className="max-w-xl w-full mx-auto bg-white dark:bg-slate-900 p-6 rounded-lg shadow-lg">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4 text-purple-500 font-spartan">
            Bill From
          </h2>
          <input
            type="text"
            ...
            onChange={(e) =>
              handleInputChange("senderAddress", e.target.value, true, "street")
            }
            className={`${
              darkMode ? "bg-[rgba(37,41,69,1)]" : ""
            } w-full border rounded py-3 px-2 mb-4`}
          />
          <div className="flex gap-4">
            <input
              ...
              onChange={(e) =>
                handleInputChange("senderAddress", e.target.value, true, "city")
              }
        ...
        <div className="mb-8">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("clientAddress", e.target.value, true, "street")
            }
            className="w-full border rounded py-3 px-2 mb-4"
          />
          <div className="flex gap-4">
            <input
              ...
              onChange={(e) =>
                handleInputChange("clientAddress", e.target.value, true, "city")
              }
              className="w-1/3 border rounded py-3 px-2"
            />
            <input
        ...
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4 text-[rgba(119,127,152,1)]">
            Item List
          </h2>
